...
import SignInForm from '../features/user/forms/SigninForm';
				...
				<Grid container component="main" sx={{ height: '100vh' }}>
					...
					<Grid item xs={12} sm={6} md={5} component={Paper} elevation={6} square>
						...
						>
							...
							<Box className="w-full sm:w-4/5 md:w-4/5 lg:w-7/12 xl:w-6/12" sx={{ mt: 4 }}>
								<SignInForm role={props.query.role} />
...
SignInSide.getInitialProps = ({ query }: any) => {
	return { query }
}
